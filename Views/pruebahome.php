...
<body>
  ...
  <div class="container">
    <div class="row">
      <div class="col s7 red"><span class="flow-text">This div is 7-columns wide on pushed to the right by 5-columns.</span></div>
      <div class="col s5 blue"><span class="flow-text">This div is 7-columns wide on pushed to the right by 5-columns.</span></div>
